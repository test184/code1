...
if ($action=="add")
{
   ...
   $classrs=setsql("select","select * From lhadmin Where lhuser='".$user."'");
	...
	$sql = "INSERT INTO lhadmin(lhuser,lhpassword,dj,lm) VALUES (:lhuser,:lhpassword,:dj,:lm)";  
	$arr = array(
    ':lhuser'=>$user,
...
<div class="crumb-list">系统管理<span class="crumb-step">&gt;</span><span class="crumb-name"><a href="SuperUser.php">用户管理</a></span><span class="crumb-step">&gt;</span><span class="crumb-name">添加用户</span></div>
</div>
<div align="center">
  

  <form name="form1" method="post" onSubmit="return check_input()" action="?action=add">
  
  
    <table  width="60%" border=0 align=center cellspacing=1 class="table-list"  >
      <tr>
        <th colspan="2" ><div align="center">添加用户</div>
            <div align="center"></div></td>
      </th>
      <tr>
        <td width="78" ><div align="center">用户名：</div></td>
        <td width="146"><input name="user" type="text"  id="user" size="20">        </td>
      </tr>
      <tr>
    ...
    <table width="60%"  align="center" class="table-list" id="lmgl" style="display:none;margin-top:0px;">
	<tr>
...
?> 			 <div id="div<?php  echo $rs[$i]['classid']; ?>">
		   <input name="blm[]" type="checkbox" value="<?php     echo $rs[$i]['classid']; ?>" onClick="if(this.checked==true) { checkAll('div<?php     echo $rs[$i]['classid']; ?>','slm'); } else { clearAll('div<?php     echo $rs[$i]['classid']; ?>','slm'); }">&nbsp;<?php     echo $rs[$i]['classname']; ?></br>
<?php 
...
?>
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="slm[]" type="checkbox" value="<?php       echo $rs_s[$j]['classid']; ?>">&nbsp;<?php       echo $rs_s[$j]['classname']; ?>&nbsp;&nbsp;
			<?php  }
